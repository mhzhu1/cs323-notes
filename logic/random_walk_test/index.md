...
\$$\begin{aligned}P[X_{t+1}=j+1\mid X_{t}=j] & \geq & \frac{1}{2}\\
...
\$$\begin{aligned}E[y_{j}] & = & \frac{1}{2}{\left(1+E[y_{j-1}]\right)}+\frac{1}{2}{\left(1+E[y_{j+1}]\right)}\\
h_{j} & = & \frac{h_{j-1}+h_{j+1}}{2}+1\end{aligned}$$
{: style="text-align: center"}
...
\$$\begin{aligned}P[X_{t+1}=j+1\mid X_{t}=j] & \geq & \frac{1}{3}\\
P[X_{t+1}=j-1\mid X_{t}=j] & \leq & \frac{2}{3}\end{aligned}$$
{: style="text-align: center"}
...
\$$\begin{aligned}h_{j} & = & \frac{2}{3}h_{j-1}+\frac{1}{3}h_{j+1}+1\\\end{aligned}$$
{: style="text-align: center"}
...
\$$\begin{aligned}q & \geq & \sum_{j=0}^{n}P(X_{0}=n-j)q_{j}\\
 ...
 & \approx & \frac{a}{\sqrt{n}}{\left(\frac{3}{4}\right)}^{n}\end{aligned}$$
{: style="text-align: center"}
